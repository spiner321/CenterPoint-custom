...
def parse_args(**kwargs):
    ...
    parser.add_argument("--sensor", default='lidar', help="determine sensor")
...
def main(**kwargs):
    ...
    logger.info(f"Sensor: {args.sensor}")
    ...
    save_pred(predictions, args.work_dir, sensor=args.sensor)

    result_dict, _ = dataset.evaluation(copy.deepcopy(predictions), output_dir=args.work_dir, testset=args.testset, anno_path=cfg.val_anno)
