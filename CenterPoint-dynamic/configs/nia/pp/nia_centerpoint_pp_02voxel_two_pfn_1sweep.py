...
model = dict(
    ...
    reader=dict(
        ...
        num_filters=[64, 64],
        num_input_features= 4, #5
        with_distance=False,
        voxel_size=(0.2, 0.2, 8),
        # pc_range=(0, -51.2, -5.0, 70.4, 51.2, 3.0),
...
test_cfg = dict(
    # post_center_limit_range=[0, -61.2, -10.0, 80.4, 61.2, 10.0],
...
nsweeps = 1
data_root = "/path/to/CenterPoint-NIA/data/nia"
...
voxel_generator = dict(
    # range=[0, -51.2, -5.0, 70.4, 51.2, 3.0],
...
log_level = "INFO"
work_dir = '/path/to/CenterPoint-NIA/work_dirs/{}/'.format(__file__[__file__.rfind('/') + 1:-3])
